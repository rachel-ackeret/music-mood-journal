...
function LatestJournalEntry(props) {
    ...
    return (
        <React.Fragment> 
            <div className="shadow my-3 p-4 rounded top-card position-relative col-lg-9 align-self-center background-light-1">
                ...
                <div className="d-lg-flex mt-5">
                    ...
                    <div className="col-lg-8">
                        ...
                        <div className="p-3"></div>
                            <button onClick={editable ? handleSaveModeButtonClick : handleEditModeButtonClick} id="form-edit" type="button" className="btn btn-primary text-align-right">
